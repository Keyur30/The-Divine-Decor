...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Mar 10, 2025 at 03:45 PM
...
INSERT INTO `offer` (`offer_id`, `start_date`, `end_date`, `discount_amt`, `Offer_discription`) VALUES
(1, '2025-02-03', '2025-02-28', 200, 'flat 200 diacount above shopping amount 1000');
...
(45, '1234567890', 2, 50, 1, '2025-03-10', 58844.00, 'Pending', 'kkkasldjljsdmfnsd', 15),
(46, '1234567890', 2, 49, 1, '2025-03-10', 15.00, 'Pending', 'kkkasldjljsdmfnsd', 15),
(47, '1234567890', 4, 34, 1, '2025-03-10', 200.00, 'Pending', 'a-401 ,gamgotri residency ,sudama chowk', 16),
(48, '1234567890', 4, 2, 3, '2025-03-10', 6000.00, 'Pending', 'a-401 ,gamgotri residency ,sudama chowk', 16),
(49, '1234567890', 4, 40, 4, '2025-03-10', 176.00, 'Pending', 'a-401 ,gamgotri residency ,sudama chowk', 16),
(50, '1234567890', 2, 34, 1, '2025-03-10', 200.00, 'Pending', 'kkkasldjljsdmfnsd', 17),
(51, '1234567890', 2, 34, 1, '2025-03-10', 200.00, 'Pending', 'kkkasldjljsdmfnsd', 18);
...
(15, 58909, 2, '2025-03-10', NULL),
(16, 6426, 8, '2025-03-10', 1),
(17, 250, 1, '2025-03-10', 2),
(18, 250, 1, '2025-03-10', NULL);

-- Modify order_details table structure
ALTER TABLE `order_details` 
DROP INDEX `delivery_person_id`,
ADD INDEX `delivery_person_id` (`delivery_person_id`);
...
(9, 45, 'TXN17415806591290', '2025-03-10', 'Pending', 'cod'),
(10, 46, 'TXN17415806596573', '2025-03-10', 'Pending', 'cod'),
(11, 47, 'TXN17415818714461', '2025-03-10', 'Pending', 'cod'),
(12, 48, 'TXN17415818718472', '2025-03-10', 'Pending', 'cod'),
(13, 49, 'TXN17415818718396', '2025-03-10', 'Pending', 'cod'),
(14, 50, 'TXN17416026723072', '2025-03-10', 'Pending', 'cod'),
(15, 51, 'TXN17416027686347', '2025-03-10', 'Pending', 'cod');
...
(1, 1, 1, 'Animal Heads (Set Of 2) B', 50, 2000, 'asas', ''),
(2, 1, 1, 'Animal Heads (Set Of 2) B', 50, 2000, '', 'Vases\\Table vases\\Animal Heads (Set Of 2) Tab'),
